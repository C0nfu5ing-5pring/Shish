  ...
  return (
    <>
      <section className="flex justify-center py-10">
        <RoughCircleHeading children="Skills and Interest" />
      </section>

      <section className="py-20 p-15 lg:px-25">
      ...
      <section className="pb-20 p-15 lg:px-25">
        <RoughHighlightHeading children="Projects" />
        ...
        <div className="flex flex-wrap mt-10 gap-10 justify-center">
          ...
          <ProjectCard
            ...
            tech={["React"]}
            github="https://github.com/C0nfu5ing-5pring/useRecipe"
            live="https://c0nfu5ing-5pring.github.io/useRecipe/"
          />
          ...
          <ProjectCard
            ...
            github="https://github.com/C0nfu5ing-5pring/Productivity-Dashboard"
            live="https://c0nfu5ing-5pring.github.io/Productivity-Dashboard/"
          />
          ...
          <ProjectCard
            ...
            github="https://github.com/C0nfu5ing-5pring/Gihub-Profile-Loader"
            live="https://c0nfu5ing-5pring.github.io/Gihub-Profile-Loader/"
          />
          ...
          <ProjectCard
            ...
            tech={["HTML", "TailwindCSS", "JS", "MySQL", "GSAP"]}
            github="https://github.com/C0nfu5ing-5pring/Alumni-Portal"
          />
        </div>
      </section>
    </>
